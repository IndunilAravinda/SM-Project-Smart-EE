                            ...
                            <div class="col-12">
                                ...
                                <!--                                <form method="post" action="">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" class="form-control" name="valid" placeholder="Reset code For Chack Your Email">
                                                                        <label >Question :  </label>
                                                                        <input type="text" name="answer" id="answer" class="form-control" placeholder="Answer">
                                                                    </div>
                                                                    <div class="form-group">
                                                                        <input type="submit" class="btn btn-primary mt-3 mb-4 px-5">
                                                                    </div>
                                                                </form>-->
                            </div>
                        </div>
...
//                document.getElementById("newpa").disabled = true;
            }
...
//                }
//            };
//            xhttp.open("Post", "chackq", true);
//            xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
//            xhttp.send("userid=" + email + "&answer=" + ans);
//
//            return q;
//        }
    </script>
